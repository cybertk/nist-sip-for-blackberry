 ...
 * 
 * @version JAIN-SIP-1.1 $Revision: 1.10 $ $Date: 2006/01/26 20:51:07 $
 * 
...
/*
 * $Log: UserAgentParser.java,v $
 * Revision 1.10  2006/01/26 20:51:07  mranga
 * *** empty log message ***
 * Revision 1.9 2005/11/28 19:02:29 mranga ***
 * empty log message ***
 * 
 * Revision 1.7 2004/01/30 17:10:47 mranga Reviewed by: mranga Server and user
 * agent parser leave an extra Linefeed at the end of token.
 * 
 * Revision 1.6 2004/01/27 13:52:11 mranga Reviewed by: mranga Fixed
 * server/user-agent parser. suppress sending ack to TU when retransFilter is
 * enabled and ack is retransmitted.
 * 
 * Revision 1.5 2004/01/22 13:26:32 sverker Issue number: Obtained from:
